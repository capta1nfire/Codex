...
# 🛑 CODEX - Stop Services Script
# Detiene todos los servicios del proyecto CODEX de forma segura
...
if $all_clear; then
    echo -e "\n${GREEN}✅ Todos los servicios CODEX han sido detenidos exitosamente${NC}"
else
