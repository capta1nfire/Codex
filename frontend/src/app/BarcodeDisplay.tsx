...
const typeLabels: Record<string, string> = {
  'qrcode': 'QR Code', 'code128': 'Code 128', 'ean13': 'EAN-13',
  'upca': 'UPC-A', 'code39': 'Code 39', 'pdf417': 'PDF417',
...
export default function BarcodeDisplay({ svgContent, type, data }: BarcodeDisplayProps) {
  ...
  const wrapperClasses = useMemo(() => {
    ...
    const baseClasses = "p-4 sm:p-6 bg-white rounded-lg border border-gray-200 shadow-sm flex flex-col items-center w-full";
