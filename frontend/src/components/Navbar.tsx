  ...
  const navigationLinks = [
    {
      href: "/",
      label: "Generador",
      icon: <QrCode className="h-4 w-4 md:mr-2" />,
      isActive: pathname === "/"
    },
    {
      href: "/dashboard/metrics",
      label: "Dashboard",
      icon: <BarChart2 className="h-4 w-4 md:mr-2" />,
      ...
      <div className="max-w-6xl mx-auto px-4">
        <nav className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center">
            {isLoading ? (
              <div className="h-8 w-24 bg-blue-800/50 rounded animate-pulse"></div>
            ) : user ? (
              <div className="relative">
                ...
                >
                  ...
                  <span className="font-medium text-white hidden sm:inline">{user.name}</span>
